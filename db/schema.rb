...
ActiveRecord::Schema.define(version: 20150924042556) do
  ...
  add_index "emails", ["category_id"], name: "index_emails_on_category_id"
  ...
  add_index "inscriptions_plants", ["inscription_id"], name: "index_inscriptions_plants_on_inscription_id"
  add_index "inscriptions_plants", ["plant_id"], name: "index_inscriptions_plants_on_plant_id"
