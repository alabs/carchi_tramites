class InscriptionsController < ApplicationController
  ...
  def create
    ...
    if @inscription.save
      ...
      redirect_to root_url, flash: { notice: @event.price? ? @event.msg_price : @event.msg_default }
    else  
      render :action => 'new'
    end  
  end  
  ...
  def inscription_params
    params.require(:inscription).permit(:event_id, :first_name, :last_name, :phone, 
      ...
      :ed_level, :ed_title, :institute_id, :observations, :rep_document_id, :rep_full_name, :rep_sex, 
